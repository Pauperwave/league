<!-- app\components\tournament\WinnerChecklist.vue -->
<script setup lang="ts">
import type { WinnerChecklistEntry } from '~/composables/tournament/useWinnerChecklist'
...
<template>
  <div v-if="winners.length > 0" class="bg-elevated rounded-xl p-2.5 border border-default shadow-lg">
    <UCollapsible v-model:open="isOpen">
      ...
      <template #content>
        <p class="text-xs text-muted mb-1.5">{{ t('tournament.winnerChecklist.hint') }}</p>
