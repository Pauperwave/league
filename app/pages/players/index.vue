...
// fallow-ignore-file code-duplication -- create/update-player handler boilerplate
// shared with useTournamentPlayers (the post-create/update flows differ: plain
// toast here, waitlist registration there)
