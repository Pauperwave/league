...
- **Stato:** leagues migrata (template, 2026-07-17): 3 endpoint (`/api/leagues/create|:id/update|:id/delete`), store `leagues.ts` e `supabase/useLeagues.ts` eliminati. Restano rulesets, players, commander-decks, events-CRUD — tracciate in BACKLOG #7 wave 4.
